  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gray-900 text-white">
      ...
      <motion.div
        ...
        className="hidden md:flex md:w-1/2 relative bg-gradient-to-br from-blue-600 via-purple-700 to-blue-800 items-center justify-center"
      >
        <img
          src="https://images.unsplash.com/photo-1605559424843-9e8e6e8f5ab3?auto=format&fit=crop&w=900&q=80"
          alt="Bike"
        ...
        >
          Welcome to <span className="text-blue-400">First Bike</span>
          <br />
          Power Your Journey 🏍️
        </motion.h1>
      </motion.div>
